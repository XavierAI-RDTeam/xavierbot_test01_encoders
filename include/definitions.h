...
#define FRONT_RIGHT_PWM_FORWARD 18
#define FRONT_RIGHT_PWM_REVERSE 17

#define REAR_LEFT_PWM_FORWARD  21
#define REAR_LEFT_PWM_REVERSE  19
#define REAR_RIGHT_PWM_FORWARD 16
#define REAR_RIGHT_PWM_REVERSE 13
